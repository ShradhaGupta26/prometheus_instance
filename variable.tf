...
variable "mongo_primary_private_ip"{
type = string
}

variable "mongo_secondary_private_ip" {
  type = list(string)
}
locals {
  mongo_secondary_private_ip_1 = element(var.mongo_secondary_private_ip, 0)
  mongo_secondary_private_ip_2 = element(var.mongo_secondary_private_ip, 1)
}
